...
LangChain (when building chains/agents)
OpenAI/Anthropic SDKs (when using specific APIs)
LiteLLM (when needing multi-provider support for chat completion)
